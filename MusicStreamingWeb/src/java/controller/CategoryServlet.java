...
public class CategoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Song> slist = sdb.getSongByCategory(categoryID);
            request.setAttribute("slist", slist);
            request.setAttribute("message", "All Song of this Category");
            request.setAttribute("currentPage", "Category");
            
            request.getRequestDispatcher("Category.jsp").forward(request, response);
        } catch (Exception e) {
            CategoryDAO cdb = new CategoryDAO();
            List<Category> clist = cdb.getAllCategory();
            request.setAttribute("clist", clist);
            request.setAttribute("message", "Choose One");
            request.setAttribute("currentPage", "Category");
