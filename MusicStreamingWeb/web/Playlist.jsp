...
<html lang="en">
    ...
    <body>
        <c:if test="${sessionScope.user.status != 'premium'}">
            <!-- Video Ads  -->
            <div class="videoAds">
                <h3 style="color: white;font-weight:500;font-size:2em">Join <a href="contract" style="color: rgb(224, 201, 69);">Premium</a> to disable Advertisement</h3>
                <div class="Ads_contents">
                    <video id="myVideo" width="100%" height="100%" autoplay="true">
                        <source src="https://res.cloudinary.com/longfpt/video/upload/v1634531452/Rick_roll_but_with_different_link_ap74js.mp4" type="video/mp4">
                    </video>
                </div> 
            </div>
            <!-- Style Ads  -->
            ...
            <script type='text/javascript'>
                ...
                function myHandler(e) {
                    ...
                    document.querySelector('.videoAds').style.display = "none"
                }
            </script>
            <!-- End Trigger Ads  -->
            <!-- End Video ADs  -->
                ...
                <div class="colection_body">
                    ...
                    <div class="body_info">
                        ...
                        <div class="body_info_text">
                            ...
                            <h2>${requestScope.listS.listName}</h2>
                            <p>Description...</p>
                        </div>
                    </div>
                                ...
                                <i class="fas fa-ellipsis-h fa-2x tooltip">
                                    <span>
                                        <span class="tooltiptext">
                                            ...
                                            <p id="my_share"><i class="fas fa-trash-alt"></i> <a href="deleteList?listID=${requestScope.listS.listID}">Delete</a></p>
                                        </span>
                                    </span>
                                </i>
                            </div>
           ...
           <div class="song_row \${index == this.currentIndex ? 'song_active' : ''}" data-index="\${index}">
                <img class="songRow_album" src="\${song.image}" />
                    <div class="songRow_info" style="width: 80%;">
                       <h1><a href="player?songID=\${song.id}">\${song.name}</a></h1>
                    </div>
                    ...
                    <i class="fas fa-ellipsis-h toolbottom">
                        <span class="tooltiptext">
                            ...
                            <p><i class="fas fa-trash-alt"></i> <a href="removeSong?listID=${requestScope.listS.listID}&&songID=\${song.id}">Delete</a></p>
                        </span>
